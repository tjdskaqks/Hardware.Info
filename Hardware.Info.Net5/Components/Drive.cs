...
namespace Hardware.Info.Net5
{
    ...
    public class Drive
    {
        ...
        public override string ToString() =>
            ...
            $"SerialNumber: {Size}{Environment.NewLine}" +
            $"Partitions: {Partitions}{Environment.NewLine}";
    }


    public class LinuxVolume
    {
        /// <summary>
        /// File system on the logical disk.
        /// </summary>
        ...
        /// <summary>
        /// Space, in bytes, used on the logical disk.
        /// </summary>
        ...
        /// Mounted Path
        /// </summary>
        public string Monunted { get; set; } = string.Empty;

        public override string ToString() =>
            $"FileSystem: {FileSystem}{Environment.NewLine}" +
            $"Size: {Size}{Environment.NewLine}" +
            $"FreeSpace: {FreeSpace}{Environment.NewLine}" +
            $"UsedSpace: {UsedSpace}{Environment.NewLine}" +
            $"UsePercent: {UsePercent}{Environment.NewLine}" +
            $"Monunted: {Monunted}{Environment.NewLine}";
    }
}
